...
/*   Updated: 2019/02/21 21:06:03 by ssitruk          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		index_base(char nbr, char *base)
{
	int i;
...
char	*base10_to_base(int base10, char *base, char *value)
{
	unsigned int	b10;
	int				blen;
	int				i;
...
int		base_to_base10(char *nbr, char *base)
{
	int blen;
	int nlen;
	int value;
